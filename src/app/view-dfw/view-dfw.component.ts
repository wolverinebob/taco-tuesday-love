...
@Component({
  selector: 'app-view-dfw',
  templateUrl: './view-dfw.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./view-dfw.component.css']
})
export class ViewDFWComponent {
  closeResult: string;
...
// EVERYTHING BELOW THIS LINE IS FOR THE SLIDER
  ...
  ngOnInit() {
  this.locale = this.dataService.getFortWorth();
}
