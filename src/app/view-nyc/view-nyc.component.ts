...
@Component({
  selector: 'app-view-nyc',
  templateUrl: './view-nyc.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./view-nyc.component.css']
})
export class ViewNYCComponent {
  closeResult: string;
...
// EVERYTHING BELOW THIS LINE IS FOR THE SLIDER
  ...
  ngOnInit() {
  this.locale = this.dataService.getNYC();
}
