...
@Component({
  selector: 'app-view-san',
  templateUrl: './view-san.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./view-san.component.css']
})
export class ViewSANComponent {
  closeResult: string;
...
// EVERYTHING BELOW THIS LINE IS FOR THE SLIDER
  ...
  ngOnInit() {
  this.locale = this.dataService.getSanDiego();
}
