...
@Component({
  selector: 'app-view-bos',
  templateUrl: './view-bos.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./view-bos.component.css']
})
export class ViewBOSComponent {
  closeResult: string;
...
// EVERYTHING BELOW THIS LINE IS FOR THE SLIDER
  ...
  ngOnInit() {
  this.locale = this.dataService.getBoston();
  }
